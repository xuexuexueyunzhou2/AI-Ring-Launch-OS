...
![Launch](https://img.shields.io/badge/Launch-45%20Days-success)
![Scope](https://img.shields.io/badge/Scope-China%20%7C%20Global-blue)
![Version](https://img.shields.io/badge/version-v1.0-lightgrey)
![System](https://img.shields.io/badge/system-GTM%20OS-orange)
...
```mermaid
gantt
    title China GTM Execution (45 Days)
    dateFormat  YYYY-MM-DD

    section Seeding (Demand Injection)
    KOL / KOC Free Sample Seeding        :a1, 2026-08-15, 10d
    Creator Content Production Cycle      :a2, 2026-08-15, 10d

    section Commerce Setup
    Pre-sale Setup (XHS / Douyin / Shop) :a3, 2026-08-15, 10d
    Official Brand Account Setup         :a4, after a3, 5d

    section Growth System
    Community & UGC Flywheel Activation  :a5, 2026-08-25, 10d
    AI Search Visibility (GEO / AEO)     :a6, 2026-08-25, 10d

    section Scaling
    Paid Conversion Activation           :a7, 2026-08-30, 15d
```
...
gantt
    ...
    Shopify Funnel + Tracking Setup      :b4, after b3, 5d

    section Growth System
    AI Search Visibility (GEO / AEO)     :b5, 2026-08-25, 10d
    Paid Ads Activation (TikTok/Meta)    :b6, 2026-08-25, 15d
